                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text(data["location"],style: TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: Color(0xFFB32525)),),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text(data["description"],style: TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: Color(0xFFB32525)),),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text(data["quantity"],style: TextStyle(fontWeight: FontWeight.w600,fontSize: 12,color: Color(0xFFB32525)),),
